...
/*public class AppointmentsAddEditController implements Initializable {
   ...
   @FXML private GridPane addAppointmentTable;
    ...
    @FXML private GridPane editAppointmentTable;
    ...
    @FXML private ComboBox editAppointmentContact;
    @FXML private TextField editAppointmentType;
    @FXML private DatePicker editAppointmentStartDate;
    @FXML private DatePicker editAppointmentEndDate;
    @FXML private TextField editAppointmentCustomerID;
    @FXML private TextField editAppointmentUserID;
    @FXML private ComboBox<LocalTime> editAppointmentStartTime;
    @FXML private ComboBox<LocalTime> editAppointmentEndTime;
